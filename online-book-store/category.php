...
$books = get_books_by_category($id);
...
$current_category = get_category($id);
?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<title><?= $current_category["result"]["name"] ?></title>
	...
	<div class="container">
		...
		<div class="d-flex pt-3">
			...
			<div class="pdf-list d-flex flex-wrap">
				<?php foreach ($books["result"]["result"] as $book) { ?>
				<div class="card m-1">
